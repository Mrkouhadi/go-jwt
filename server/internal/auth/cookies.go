...
// /// NB:Note: When using AES-GCM encryption, it's important that your secret key is exactly 32 bytes long.
// Otherwise you will get a runtime error like crypto/aes: invalid key size <N>.
var (
